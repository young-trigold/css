...
- [1. 选择器](#1-选择器)
  ...
  - [1.3. 选择器组合](#13-选择器组合)
  - [1.4. 简单选择器](#14-简单选择器)
    - [1.4.1. 类型选择器](#141-类型选择器)
    - [1.4.2. 通用选择器](#142-通用选择器)
    - [1.4.3. 属性选择器](#143-属性选择器)
      - [1.4.3.1. 属性存在和值选择器](#1431-属性存在和值选择器)
      - [1.4.3.2. 子字符串匹配属性选择器](#1432-子字符串匹配属性选择器)
    - [1.4.4. 类选择器](#144-类选择器)
    - [1.4.5. ID 选择器](#145-id-选择器)
    - [1.4.6. 伪类](#146-伪类)
      - [1.4.6.1. 动态伪类](#1461-动态伪类)
      - [1.4.6.2. :target](#1462-target)
      - [1.4.6.3. :lang](#1463-lang)
      - [1.4.6.4. UI 元素状态伪类](#1464-ui-元素状态伪类)
      - [1.4.6.5. 结构性伪类](#1465-结构性伪类)
      - [1.4.6.6. 否定伪类](#1466-否定伪类)
  - [1.5. 伪元素](#15-伪元素)
    - [1.5.1. ::after 和 ::before](#151-after-和-before)
    - [1.5.2. ::first-line](#152-first-line)
    - [1.5.3. ::first-letter](#153-first-letter)
    - [1.5.4. ::selection](#154-selection)
  - [1.6. 组合器](#16-组合器)
    - [1.6.1. 后代元素组合器](#161-后代元素组合器)
    - [1.6.2. 子元素选择器](#162-子元素选择器)
    - [1.6.3. 后续兄弟元素选择器](#163-后续兄弟元素选择器)
    - [1.6.4. 下一个兄弟元素选择器](#164-下一个兄弟元素选择器)
  - [1.7. 选择器特指度](#17-选择器特指度)
