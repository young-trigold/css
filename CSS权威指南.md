...
- [2. 语法和基本数据类型](#2-语法和基本数据类型)
  ...
  - [2.4. 值和单位](#24-值和单位)
    ...
    - [2.4.2. 文本数据类型](#242-文本数据类型)
      ...
      - [2.4.2.2. `<custom-ident>` 类型](#2422-custom-ident-类型)
      - [2.4.2.3. `<string>` 类型](#2423-string-类型)
      - [2.4.2.4. `<url>` 类型](#2424-url-类型)
    - [2.4.3. 数字数据类型](#243-数字数据类型)
      - [2.4.3.1. 范围限制和范围定义记法](#2431-范围限制和范围定义记法)
      - [2.4.3.2. `<integer>` 类型](#2432-integer-类型)
      - [2.4.3.3. `<number>` 类型](#2433-number-类型)
      - [2.4.3.4. 尺寸值](#2434-尺寸值)
    - [2.4.4. `<percentage>` 类型](#244-percentage-类型)
    - [2.4.5. 混合百分数和尺寸](#245-混合百分数和尺寸)
    - [2.4.6. 距离单位](#246-距离单位)
      - [2.4.6.1. 相对长度单位](#2461-相对长度单位)
      - [2.4.6.2. 绝对长度单位](#2462-绝对长度单位)
    - [2.4.7. 其他量](#247-其他量)
      - [2.4.7.1. 角度单位](#2471-角度单位)
      - [2.4.7.2. 时长单位](#2472-时长单位)
      - [2.4.7.3. 频率单位](#2473-频率单位)
      - [2.4.7.4. 分辨率单位](#2474-分辨率单位)
    - [2.4.8. 其他数据类型](#248-其他数据类型)
      - [2.4.8.1. `<color>` 类型](#2481-color-类型)
      - [2.4.8.2. `<image>` 类型](#2482-image-类型)
      - [2.4.8.3. `<position>` 类型](#2483-position-类型)
    - [2.4.9. 函数记法](#249-函数记法)
      - [2.4.9.1. cal()](#2491-cal)
    - [2.4.10. attr()](#2410-attr)
- [3. 选择器](#3-选择器)
  - [3.1. 选择器简介](#31-选择器简介)
  - [3.2. 选择器语法](#32-选择器语法)
  - [3.3. 选择器组](#33-选择器组)
...
在下面的例子中，用户样式表的第一条规则包含一个!important 声明，它覆盖了作者样式表的相应声明。第二条规则中的声明也会因为被标记为!important 而获胜。然而，用户样式表中的第三个声明不是!important 的，因此会输给作者样式表中的第二条规则（它恰好在一个速记属性上设置样式）。另外，第三个作者规则将输给第二个作者规则，因为第二个声明是!important 的。这表明!important 声明在作者样式表中也有作用。
