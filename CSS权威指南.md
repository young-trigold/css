...
- [2. 语法和基本数据类型](#2-语法和基本数据类型)
  - [2.1. 语法](#21-语法)
    - [2.1.1. 样式规则](#211-样式规则)
    - [2.1.2. 关键字](#212-关键字)
      - [2.1.2.1. inherit](#2121-inherit)
      - [2.1.2.2. initial](#2122-initial)
      - [2.1.2.3. unset](#2123-unset)
      - [2.1.2.4. 厂商前缀](#2124-厂商前缀)
    - [2.1.3. 空白](#213-空白)
    - [2.1.4. 注释](#214-注释)
  - [2.2. 值](#22-值)
    - [2.2.1. 数值](#221-数值)
    - [2.2.2. 长度](#222-长度)
      - [2.2.2.1. 绝对单位](#2221-绝对单位)
      - [2.2.2.2. 相对单位](#2222-相对单位)
    - [2.2.3. 百分数](#223-百分数)
    - [2.2.4. URL](#224-url)
    - [2.2.5. 颜色](#225-颜色)
    - [2.2.6. 字符串](#226-字符串)
